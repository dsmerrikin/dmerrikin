export default function handler(req, res) {
  res.status(200).json([
    ...
    },
    {
      ...
      ensuring smooth end-to-end functionality. In addition to building a new MERN application for a major insurance company with seamless 
      Next.js integration for RESTful API usage, I spearheaded the creation of an automated Lambda function that logged JSON events to an 
      S3 bucket via CloudWatch. Throughout my tenure, I also focused on coaching and mentoring team members, 
